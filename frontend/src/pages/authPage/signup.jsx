...
//     try {
//       // use the api instance and the backend route mounted at /user
//       await api.post("/user/add", form); // change to match your backend route
...
//         {message && (
//           <p className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-3 mb-4 rounded">
//             {message}
//           </p>
//         )}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0441b1] to-blue-700 px-4">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-2xl border-t-4 border-[#0441b1]">
        <h2 className="text-3xl font-extrabold text-[#0441b1] text-center mb-6">
          Create Account
        </h2>
        ...
        <p className="text-center mt-5 text-sm text-gray-600">
          Already have an account?{" "}
          <Link to="/login" className="text-[#0441b1] font-semibold hover:underline">
            Login
          </Link>
        </p>
      </div>
